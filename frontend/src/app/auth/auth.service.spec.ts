...
export class AuthenticationService {
  ...
  constructor() {
    ...
    this.users.push({userId: uuid.v4(), username: "Basma", password: "1234"})
    this.users.push({userId: uuid.v4(), username: "Salma", password: "1234"})
    this.users.push({userId: uuid.v4(), username: "ghiz", password: "1234"})
